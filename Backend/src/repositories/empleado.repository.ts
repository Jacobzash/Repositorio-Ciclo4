...
> {
  ...
  constructor(
    @inject('datasources.sprintEmpresa') dataSource: SprintEmpresaDataSource, @repository.getter('EmpresaRepository') protected empresaRepositoryGetter: Getter<EmpresaRepository>, @repository.getter('MensajesEmpleadosRepository') protected mensajesEmpleadosRepositoryGetter: Getter<MensajesEmpleadosRepository>,
  ) {
